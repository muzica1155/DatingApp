...
namespace API.Data
{
...

    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)// we say void bcoz we dont return anthing from this & then we call it 
        {
           ...
           .IsRequired();
            ...
            {
                k.SourceUserId,
                k.LikedUserId // this is going to form the primary key for this particular table
            ...
            //after optimization query1
            builder.ApplyUtcDateTimeConverter();//what we can do then is after entity configuration inside the OnModel creating & say
             //this thing to come after all of our entity configurations what we r using below method this is gonna ensure that all of our
    ...
    public static class UtcDateAnnotation
    {
        ...
        private static readonly ValueConverter<DateTime?, DateTime?> UtcNullableConverter =
          new ValueConverter<DateTime?, DateTime?>(v => v, v => v == null ? v : DateTime.SpecifyKind(v.Value, DateTimeKind.Utc));//checking in here to see if the date time is null if it is then it's gonna do smthing & will make use of this 
    ...
    }//this code simply gonna convert our daytimes into UTC thats the goal of this 
}